...
function render(data) {
  ...
  shareBtn.className = 'px-4 py-2 bg-gray-900 text-white text-sm rounded hover:bg-gray-700 transition-colors';
  shareBtn.textContent = 'Share';

  const shareInput = document.createElement('input');
  shareInput.type = 'text';
  shareInput.readOnly = true;
  shareInput.className = 'hidden border border-gray-300 rounded px-3 py-2 text-sm flex-1';
  ...
  actions.append(shareBtn, shareInput, visualLink);
